...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="pt-32 pb-20 px-4 md:px-6 overflow-hidden relative w-full min-h-screen flex items-center bg-[#0B0A10]">
      {/* Background Aesthetic */}
      <motion.div style={{ y: yBg }} className="absolute top-0 left-0 w-full h-[800px] pointer-events-none opacity-50">
        <div className="absolute top-[-20%] left-1/4 w-[600px] h-[600px] bg-indigo-600/30 rounded-full blur-[140px]" />
      </motion.div>

      <motion.div style={{ y: yText, opacity }} className="max-w-4xl mx-auto w-full relative z-10 flex flex-col items-center text-center">
