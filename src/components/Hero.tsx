    ...
    <section className="pt-32 pb-20 px-4 md:px-6 overflow-hidden relative w-full min-h-screen flex items-center bg-[#0B0A10]">
      ...
      <div className="max-w-4xl mx-auto w-full relative z-10 flex flex-col items-center text-center">
          <div className="w-full">
            ...
            <h1 className="text-5xl sm:text-[3.5rem] md:text-[5rem] lg:text-[6.5rem] font-black uppercase tracking-[-0.04em] leading-[0.85] text-white mb-8">
               <span className="block hover:text-indigo-100 transition-colors animate-fade-in-up" style={{ animationDelay: '0ms', animationFillMode: 'both' }}>
                 WE BUILD
               </span>
               <span className="block bg-gradient-to-r from-indigo-400 to-indigo-600 bg-clip-text text-transparent transform animate-fade-in-up" style={{ animationDelay: '100ms', animationFillMode: 'both' }}>
                 DIGITAL
               </span>
               <span className="block mb-6 hover:text-indigo-100 transition-colors animate-fade-in-up" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
                 EMPIRES
               </span>
            </h1>

            <h2 className="animate-fade-in-up text-xl sm:text-2xl md:text-3xl font-bold text-white/90 mb-4 tracking-tight max-w-2xl mx-auto" style={{ animationDelay: '300ms', animationFillMode: 'both' }}>
              Enterprise-Grade Web Solutions for Ambitious Brands
            </h2>

            <p className="text-white/60 text-base sm:text-lg md:text-xl max-w-lg mb-10 font-light leading-relaxed mx-auto">
