...
export default function Work({ isPage, limit }: { isPage?: boolean, limit?: number }) {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Next.js • Modern E-commerce',
      icon: '⚡',
      theme: 'purple',
      link: 'https://store-livid-eta-64.vercel.app/',
      image: "https://images.unsplash.com/photo-1498049794561-7780e7231661?auto=format&fit=crop&q=80&w=2670"
    }
  ];
