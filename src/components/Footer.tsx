        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-24 border-t border-white/10 pt-16">
          <div className="lg:col-span-5 lg:pr-8">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.facebook.com/profile.php?id=61590060603196" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#00e5ff] hover:border-[#00e5ff] hover:text-black transition-all duration-300 shadow-sm hover:shadow-[0_0_15px_rgba(0,229,255,0.4)]">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/_hinton.evolution.tech_?igsh=MTVscDVpOWN0cGUxMw==" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#00e5ff] hover:border-[#00e5ff] hover:text-black transition-all duration-300 shadow-sm hover:shadow-[0_0_15px_rgba(0,229,255,0.4)]">
