      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div 
            ...
            className="absolute top-full left-0 w-full bg-[#0B0A10] border-t border-white/10 md:hidden z-50 overflow-y-auto"
          >
            <div className="flex flex-col p-6 max-w-7xl mx-auto gap-2 pb-32">
              {isAdmin && (
                <motion.button 
