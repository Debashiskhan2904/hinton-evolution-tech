  ...
  const plans = [
    {
      ...
      badge: 'STARTER',
      price: '₹25,000',
      monthlyPrice: '₹2,399/mo',
      oldPrice: '₹35,000',
      description: 'Designed for businesses that want a faster, more professional, and conversion-focused online presence.',
      theme: 'cyan-basic',
      features: [
        '5 Page Website',
      ...
      customization: 'Up to 20 requested modifications',
      revisions: '2 Rounds of Revisions',
      support: '15 Days of Post-Launch Technical Support',
      btnText: 'Get Started'
    },
    {
      name: 'Intermediate',
      badge: 'GROWTH',
      price: '₹45,000',
      monthlyPrice: '₹3,899/mo',
      oldPrice: '₹60,000',
      description: 'Built for established businesses that want a premium digital presence focused on growth, performance, and customer conversion.',
      ...
      customization: 'Up to 25 requested modifications',
      revisions: '4 Rounds of Revisions',
      support: '2 Months of Post-Launch Support',
      btnText: 'Get Started'
    },
    {
      name: 'Advance',
      badge: 'PREMIUM',
      price: '₹90,000',
      monthlyPrice: '₹7,799/mo',
      oldPrice: '₹1,50,000',
      description: 'A complete digital growth solution designed for businesses ready to scale, improve visibility, and generate leads.',
      theme: 'gold',
      features: [
        'Ecommerce Store',
        'Up to 50 Products',
      ...
      customization: 'Custom scope & flexibility',
      revisions: 'Flexible',
    ...
    <section id="pricing" className={`px-4 md:px-6 bg-[#0B0B14] text-white ${isPage ? 'pt-24 md:pt-28 pb-20 md:pb-32' : 'py-20 md:py-32'}`}>
      ...
      >
        ...
        <div className="flex justify-center mb-12">
          <div className="bg-[#12121d] p-1.5 rounded-full border border-white/10 flex items-center shadow-[0_0_20px_rgba(0,0,0,0.5)]">
            <button 
              onClick={() => setIsMonthly(false)}
              className={`px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 ${!isMonthly ? 'bg-[#00e5ff] text-black shadow-[0_0_15px_rgba(0,229,255,0.3)]' : 'text-white/60 hover:text-white'}`}
            >
              One-time
            </button>
            <button 
            ...
            >
              ...
              <div className="mb-4 flex items-end gap-3 flex-wrap">
                <div className={`text-4xl sm:text-[2.5rem] font-black leading-none ${themeColors.text} transition-all duration-300`}>
                  {isMonthly ? plan.monthlyPrice : plan.price}
                </div>
              </div>
